...
use std::{collections::HashMap, fmt::Debug, str::Bytes};

use curv::{
    elliptic::curves::{Bls12_381_1, Scalar},
    BigInt,
};
use num::pow;
...
impl Tree {
    ...
    pub fn set_time(tree_vec: &mut Vec<TreeNode>, level: usize) {
        ...
        for i in 1..num_leaf {
            ...
            tree_vec[first_leaf_order].tau.realtime =
                final_time.format("%Y-%m-%d %H:%M:%S").to_string();
