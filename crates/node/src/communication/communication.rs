...
pub fn setup_to_gstbk(msg_setup: gs_tbk_scheme::messages::node::common_msg::SetupMsg) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgN(
        gs_tbk_scheme::messages::node::common_msg::GSTBKMsg::SetupMsg(msg_setup),
    ))
    .unwrap();
    return msg_str;
}
...
pub fn keygen_to_gstbk(msg_keygen: gs_tbk_scheme::messages::node::common_msg::KeyGenMsg) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgN(
        gs_tbk_scheme::messages::node::common_msg::GSTBKMsg::KeyGenMsg(msg_keygen),
    ))
    .unwrap();
    return msg_str;
}
...
pub fn join_issue_to_gstbk(
    msg_join: gs_tbk_scheme::messages::node::common_msg::JoinIssueMsg,
) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgN(
        gs_tbk_scheme::messages::node::common_msg::GSTBKMsg::JoinIssueMsg(msg_join),
    ))
    .unwrap();
    return msg_str;
}
...
pub fn revoke_to_gstbk(msg_revoke: gs_tbk_scheme::messages::node::common_msg::RevokeMsg) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgN(
        gs_tbk_scheme::messages::node::common_msg::GSTBKMsg::RevokeMsg(msg_revoke),
    ))
    .unwrap();
    return msg_str;
}
...
pub fn open_to_gstbk(msg_open: gs_tbk_scheme::messages::node::common_msg::OpenMsg) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgN(
        gs_tbk_scheme::messages::node::common_msg::GSTBKMsg::OpenMsg(msg_open),
    ))
    .unwrap();
    return msg_str;
}
...
pub fn key_manage_to_gstbk(
    msg_key_manage: gs_tbk_scheme::messages::node::common_msg::KeyManageMsg,
) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgN(
        gs_tbk_scheme::messages::node::common_msg::GSTBKMsg::KeyManageMsg(msg_key_manage),
    ))
    .unwrap();
    return msg_str;
}
