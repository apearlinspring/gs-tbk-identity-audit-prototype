...
) -> Result<GSTBKMsg, Box<dyn std::error::Error>> {
...
/// 拆分处理各种类型的消息
pub async fn handle_setup_msg(
    msg: NodeToProxySetupPhaseP2PMsg,
    msg_vec: &Arc<TokioMutex<Vec<NodeToProxySetupPhaseP2PMsg>>>,
    msg_num: &Arc<TokioMutex<i32>>,
) {
...
pub async fn handle_setup_tag(
    msg: NodeSetupPhaseFinishFlag,
    node_setup_finish_vec: &Arc<TokioMutex<Vec<NodeSetupPhaseFinishFlag>>>,
    finish_num: &Arc<TokioMutex<i32>>,
) {
...
pub fn setup_to_gstbk(msg_setup: gs_tbk_scheme::messages::proxy::common_msg::SetupMsg) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgP(
        gs_tbk_scheme::messages::proxy::common_msg::GSTBKMsg::SetupMsg(msg_setup),
    ))
    .unwrap();
    return msg_str;
}
...
/// 序列化keygen阶段的消息
pub fn keygen_to_gstbk(
    msg_keygen: gs_tbk_scheme::messages::proxy::common_msg::KeyGenMsg,
) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgP(
        gs_tbk_scheme::messages::proxy::common_msg::GSTBKMsg::KeyGenMsg(msg_keygen),
    ))
    .unwrap();
    return msg_str;
}
...
/// 序列化join阶段的消息
pub fn join_issue_to_gstbk(
    msg_join: gs_tbk_scheme::messages::proxy::common_msg::JoinIssueMsg,
) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgP(
        gs_tbk_scheme::messages::proxy::common_msg::GSTBKMsg::JoinIssueMsg(msg_join),
    ))
    .unwrap();
    return msg_str;
}
...
/// 序列化revoke阶段的消息
pub fn revoke_to_gstbk(
    msg_revoke: gs_tbk_scheme::messages::proxy::common_msg::RevokeMsg,
) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgP(
        gs_tbk_scheme::messages::proxy::common_msg::GSTBKMsg::RevokeMsg(msg_revoke),
    ))
    .unwrap();
    return msg_str;
}
...
/// 序列化verify阶段的消息
pub fn verify_to_gstbk(
    msg_verify: gs_tbk_scheme::messages::proxy::common_msg::VerifyMsg,
) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgP(
        gs_tbk_scheme::messages::proxy::common_msg::GSTBKMsg::VerifyMsg(msg_verify),
    ))
    .unwrap();
    return msg_str;
}
...
pub fn open_to_gstbk(msg_open: gs_tbk_scheme::messages::proxy::common_msg::OpenMsg) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgP(
        gs_tbk_scheme::messages::proxy::common_msg::GSTBKMsg::OpenMsg(msg_open),
    ))
    .unwrap();
    return msg_str;
}
...
/// 序列化key manage阶段的消息
pub fn key_manage_to_gstbk(
    msg_key_manage: gs_tbk_scheme::messages::proxy::common_msg::KeyManageMsg,
) -> String {
    let msg_str = serde_json::to_string(&gs_tbk_scheme::messages::common_msg::GSTBKMsg::GSTBKMsgP(
        gs_tbk_scheme::messages::proxy::common_msg::GSTBKMsg::KeyManageMsg(msg_key_manage),
    ))
    .unwrap();
    return msg_str;
}
...
pub async fn broadcast_to_user(
    user_info: &HashMap<u16, UserInfo>,
    msg: &String,
) -> Result<(), anyhow::Error> {
